...
def click_link(driver):
    ...
    for i in range(NUM_OF_CLICKS):
        ...
        while True:
            try:
                elements = driver.find_elements_by_xpath("//*[contains(text(),'The Band')]")
                elements[0].click()
                if (i % 3 == 0):
                    try:
                        ...
                        try:
                            driver.find_element_by_xpath("/html/body/div[2]/div/div[2]/div[2]/div[1]/div/div/div[3]/div[1]/div/div/div/div/div/div[1]/div[3]/button/span/span/span").click()
                        except:
                            pass
                for j in range (i):
        ...
        while True:
                try:
                    ...
                    pass
        # driver.find_element_by_xpath("//*[@id='searchBoxColumnContainerId']/div[1]/button/span/i").click()
        driver.refresh()
